...
public class MGSelect : MonoBehaviour
{
    ...
    {
        score = 0;
        SelectTime.Instance.MGNumber = 0;
    }
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Space) && score == 0)
        {
            one.SetActive(true);
            score = 1;
            SelectTime.Instance.MGNumber = 1;
        }
        ...
        else if (Input.GetKeyDown(KeyCode.Space) && score == 1)
        {
            ...
            two.SetActive(true);
            score = 2;
            SelectTime.Instance.MGNumber = 2;
        }
        else if (Input.GetKeyDown(KeyCode.Space) && score == 2)
        {
            ...
            score = 3;
            SelectTime.Instance.MGNumber = 3;
        }
